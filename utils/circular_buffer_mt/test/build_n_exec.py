...
fut = ('circular_buffer_mt',
       'circular_buffer_mt_wbox',
       )[0]
...
if enable_logger:
    # Turn On/Off module specific logging
    cbuf_mt_log_enable = (False, True)[1]

    # Set Logging level
    logger_level = 2  # 0 to 6 are valid values.
...
if enable_logger:
    ...
    if cbuf_mt_log_enable:
        def_str += " -DCBUF_MT_LOG_ENABLE"
def_str += "\""
